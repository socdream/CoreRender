...
namespace CoreRender.Delaunay
{
    public class DelaunayCalculator
    {
        ...
        public DelaunayTriangulation CalculateTriangulation(IList<float[]> verts)
        {
        ...
        public void CalculateTriangulation(IList<float[]> verts, ref DelaunayTriangulation result)
        {
            if (verts is null)
        ...
        void ShuffleIndices()
        {
            ...
            {
                var j = random.Next(i, verts.Count);

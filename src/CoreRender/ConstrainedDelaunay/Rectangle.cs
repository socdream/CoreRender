...
namespace CoreRender.ConstrainedDelaunay
{
    ...
    public struct Rectangle : IEquatable<Rectangle>
    {
        ...
        /// </summary>
        /// <param name="p"></param>
        public void Encapsulate(float[] p)
        {
            if (p.X() < MinX)
        ...
        public float[] TopLeft => new float[] { MinX, MinY };

        /// <summary>
        /// Gets the position of the top-right corner of the rectangle.
        /// </summary>
        /// <value>The top-right corner of the rectangle.</value>
        public float[] TopRight => new float[] { MaxX, MinY };

        /// <summary>
        /// Gets the position of the bottom-left corner of the rectangle.
        /// </summary>
        /// <value>The bottom-left corner of the rectangle.</value>
        public float[] BottomLeft => new float[] { MinX, MaxY };

        /// <summary>
        /// Gets the position of the bottom-right corner of the rectangle.
        /// </summary>
        /// <value>The bottom-right corner of the rectangle.</value>
        public float[] BottomRight => new float[] { MaxX, MaxY }; 
        ...
        public void Contains(ref float[] value, out bool result)
        {
        ...
        public bool Contains(float[] vector2D)
        {
        ...
        public static void Intersect(ref Rectangle value1, ref Rectangle value2, out Rectangle result)
        {
            ...
            float newRight = (value1.MaxX < value2.MaxX) ? value1.MaxX : value2.MaxX;
            float newBottom = (value1.MaxY < value2.MaxY) ? value1.MaxY : value2.MaxY;
